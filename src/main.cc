...
int main() {
  ...
  //   cout << *std_it_2 << " yyy " << *s21_it_2 << " pppp " <<
  //   *s21_List_2.end()-- <<  endl;
  ...
  // // for(s21::List<double>::iterator it = s21_List.begin(); it !=
  // s21_List.end(); it++){
  //     // cout << *s21_it_12<< " / " ;
  ...
  // cout << "Erase_f " << *std_it1 << " and " << *s21_it1 << " Size " <<
  // s21_List.size() << endl; if (s21_it1 != s21_it2){
  ...
  //     // cout << *(--std_List.end()) << " and "<< *(--s21_List.end()) <<
  //     endl; cout << endl;
  //    ++std_it_2, ++s21_it_2;
  //    ++std_it_b;
  //   }
  ...
  //   {
  //         cout << s21_List.front() << " and " <<  std_List.front() << endl;
  //         s21_List.pop_front();
  //         std_List.pop_front();
  //   }
  ...
  // //   {
  // //         cout << s21_List_in.back() << " and " << std_List_in.back() <<
  // endl;
  ...
  //   cout << *(--std_List.end())<< " 0_and_e " <<  *(--s21_List.end()) <<
  //   endl;
  ...
  //   s21_it++;
  //   s21_it++;
  // std_List.splice(std_it, std_List_2);
  // s21_List.splice(s21_it, s21_List_2);
  // s21_List.pop_front();
  ...
  //   std::list<double>::iterator std_it_5 = std_List.begin();
  //   s21::List<double>::iterator s21_it_5 = s21_List.begin();

  //   std::list<double>::iterator std_it_5_e = --std_List.end();
  // //   for(; std_it_5_e != std_List.begin() /*&& std_it_5_e !=
  // ++std_List.begin()*/; --std_it_5, --s21_it_5) {
  ...
  // //     // cout << *std_List.begin() << " and " << *s21_List.begin() <<
  // endl;
  // //     // cout << *(--std_List.end()) << " and " << *(--s21_List.end()) <<
  // endl;
  ...
  // //   cout << *(--std_List.end())<< " and_e " <<  *(--s21_List.end()) <<
  // endl; std_it_1++, s21_it_1++; std_it_b1++;
  // }

  // cout << std_List_2.size()<< " and_s " <<  s21_List_2.size() << endl;
  //   cout << std_List_2.front()<< " and_f " <<  s21_List_2.front() << endl;
  //     cout << *std_List_2.begin()<< " and_be " <<  *s21_List_2.begin() <<
  //     endl;
  //   cout << std_List_2.back()<< " and_bc " <<  s21_List_2.back() << endl;
  //   cout << *(--std_List_2.end())<< " and_e " <<  *(--s21_List_2.end()) <<
  //   endl;
  ...
  // //   for (int i = 0;  i < std_List_in.size(); i++)
  // //   {
  // //         cout << s21_List_in.front() << " and " <<  std_List_in.front()
  // << endl;
  ...
  // //   cout << *std_it_sp << " !!!!!!!!!! and_it " << *s21_it_sp << endl;
  // //   s21_List_sp_1.splice(s21_it_sp, s21_List_sp_2);
  // //   std_List_sp_1.splice(std_it_sp, std_List_sp_2);
  // //   cout << *std_it_sp << " !!!!!!!!!! and_it " << *s21_it_sp << endl;

  // //   cout << s21_List_sp_1.size() << " and_s0 " << std_List_sp_1.size() <<
  // endl;
  // //   cout << s21_List_sp_2.size() << " and_s0 " << std_List_sp_2.size() <<
  // endl;
  //   cout  << endl;
  ...
  //     // cout << *std_it_sp << " and_it " << *s21_it_sp << endl;
  //     // cout << *(++std_it_sp )<< " and_it++ " << *(++s21_it_sp) << endl;
  //     // cout << std_List_sp_1.size() << " and_s " << s21_List_sp_1.size()<<
  //     endl;
  //     // cout << *std_List_sp_1.begin() << " and_be " <<
  //     *s21_List_sp_1.begin()<< endl;
  //     // cout << *(--std_List_sp_1.end()) << " and_e " <<
  //     *(--s21_List_sp_1.end())<< endl;

  //     // cout << std_List_sp_2.size() << " and_s2 " << s21_List_sp_2.size()<<
  //     endl;
  //     // cout << *std_List_sp_2.begin() << " an_be2 " <<
  //     *s21_List_sp_2.begin()<< endl;
  //     // cout << *(--std_List_sp_2.end()) << " and_e2  " <<
  //     *(--s21_List_sp_2.end())<< endl;
  //     // cout << *(std_List_sp_2.end()) << " and_e2  " <<
  //     *(s21_List_sp_2.end())<< endl;
...
//   std_List.emplace(std_List.cbegin(), 91);
  ...
  //   std::list<double> std_copy(std_List_2);
  //   s21::List<double> s21_copy(s21_List_2);
  ...
  // cout << *std_List.begin() << " and_l " << *(std_List.begin()) << endl;
  // cout << endl;
  ...
  // cout<< "Элементов в списке" << std_List.Gestd_Listize() << endl << "Забрали
  // первый элемент" << endl << endl;
